                                ...
                                <ul class="ul_li_block clearfix">
                                    <li>
                                        <div class="checkbox_item mb-0 pl-0">
                                            <label for="cash_delivery"><input id="cash_delivery" type="radio" name="payment_method" value="1" checked>
                                                Cash On Delivery
                                            </label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="checkbox_item mb-0 pl-0">
                                            <label for="paypal_checkbox"><input id="paypal_checkbox" type="radio" name="payment_method" value="2">
                                                Paypal
                                                <a href="#!">
