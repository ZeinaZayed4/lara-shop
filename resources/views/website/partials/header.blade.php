                ...
                <div class="col-lg-3">
                    <div class="supermarket_header_btns clearfix">
                        <ul class="action_btns_group ul_li_right clearfix">
                            ...
                            @else
                                <li>
                                    <a href="{{ url('register') }}" class="btn btn-outline-secondary btn-sm text-dark">
                                        New Account
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ url('login') }}" class="btn btn-outline-secondary btn-sm text-dark">
                                        Sign in
                                    </a>
                                </li>
                            @endif
                                        ...
                                        <li>
                                            <a href="{{ url('/category/' . $category->id) }}">
                                                <span class="item_image">
                                                    <img src="{{ asset($category->photo) }}" alt="{{ asset($category->name) }}"
